...
# https://docs.microsoft.com/en-us/machine-learning-server/r/how-to-execute-code-remotely

# TODO: 2. Configure remote login
# Connect to R Server VM using remoteLogin
remoteLogin(
    deployr_endpoint = "http://13.82.180.105:12800",
    username = "admin",
    password = "Axyz5549$"
)
...
print("Result:")
print(result$output("purchasePrice"))
result
